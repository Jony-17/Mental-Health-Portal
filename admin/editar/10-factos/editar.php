                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                ...
                                $query = "SELECT factos_10.10_factos_id, factos_10.nº, factos_10.descricao, factos_10.fonte, factos_10.perturbacoes_id, perturbacoes.nome AS perturbacoes
                                          FROM factos_10
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    ?>
                                    <form action="10-factos.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="factos_id" value="<?php echo $row['10_factos_id'] ?>">
                                        <input type="hidden" name="perturbacoes_id" value="<?php echo $row['perturbacoes_id'] ?>">

                                        <div class="form-group">
                                            <label>Perturbação</label>
                                            <input type="text" name="perturbacao" value="<?php echo $row['perturbacoes'] ?>"
                                                class="form-control" placeholder="Editar perturbação">
                                        </div>

                                        <div class="form-group">
                                            <label>Número</label>
                                            <input type="text" name="nº" value="<?php echo $row['nº'] ?>" class="form-control"
