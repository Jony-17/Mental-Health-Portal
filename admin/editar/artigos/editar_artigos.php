                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Editar dados do artigo</h5>
                            ...
                            <form action="artigos.php" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="preco" class="form-control" value="<?php echo $row['nome'] ?>">
                                    </div>

                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                    <button type="submit" name="editarbtn" class="btn btn-primary">Guardar</button>
                                </div>
                            </form>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Editar artigos
                            </h6>
                        </div>
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            while ($row = mysqli_fetch_assoc($query_run)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="artigos.php" method="post">
                                                            <button type="button" class="btn btn-primary" name="editarbtn"
