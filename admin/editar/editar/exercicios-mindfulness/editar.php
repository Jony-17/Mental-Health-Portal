                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Atividades
                            </h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                $exercicios_mindfulness_id = $_POST['edit_id'];
                                $exercicios_mindfulness_ex_id = $_POST['edit_id2'];
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    <form action="exercicios-mindfulness.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="exercicios_mindfulness_ex_id"
                                            value="<?php echo $row['exercicios_mindfulness_ex_id'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($row['banner'])): ?>
                                                <img src="../../inserir/imgs/exercicios-mindfulness/banners/<?php echo $row['banner']; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="definicao" value="<?php echo $row['definicao'] ?>"
                                                class="form-control" placeholder="Editar definição">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($row['img'])): ?>
                                                <img src="../../inserir/imgs/exercicios-mindfulness/atividades/<?php echo $row['img']; ?>"
                                                    alt="Imagem atual" style="max-width: 200px; max-height: 200px;">
                                            <?php else: ?>
                                                <span>Nenhuma imagem disponível.</span>
                                            <?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            <label>Áudio</label><br>
                                            <?php if (!empty($row['audio'])): ?>
                                                <audio controls muted loop>
                                                    <source
                                                        src="../../inserir/imgs/exercicios-mindfulness/audios/<?php echo $row['audio']; ?>"
                                                        type="audio/mpeg">
                                                    Your browser does not support the audio element.
                                                </audio>
                                            <?php else: ?>
                                                <span>Nenhum áudio disponível.</span>
                                            <?php endif; ?>
                                        </div>
