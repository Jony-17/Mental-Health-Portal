                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Grupos de Perturbações
                            </h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                $grupos_perturbacoes_id = $_POST['edit_id'];

                                $query = "SELECT * FROM grupos_perturbacoes WHERE grupos_perturbacoes_id = $grupos_perturbacoes_id";
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    ?>
                                    <form action="grupos-perturbacoes.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="grupos_perturbacoes_id" value="<?php echo $row['grupos_perturbacoes_id'] ?>">
