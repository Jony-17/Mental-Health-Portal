                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    ?>
                                    <form action="juncao-perturbacoes-personalidade.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="juncao_pert_pers_id" value="<?php echo $row['juncao_pert_pers_id'] ?>">
