                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    <form action="juncao-perturbacoes.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="perturbacao" class="form-control">
                                                ...
                                                while ($row_perturbacao = mysqli_fetch_assoc($result_perturbacoes)): ?>
                                                    <option value="<?php echo $row_perturbacao['perturbacoes_id']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="grupos_perturbacoes" class="form-control">
                                                <?php
                                                ...
                                                while ($row_grupo = mysqli_fetch_assoc($result_grupos_perturbacoes)): ?>
                                                    <option value="<?php echo $row_grupo['grupos_perturbacoes_id']; ?>">
