                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Notícias
                            </h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                ...
                                WHERE
                                noticias.noticias_id = '$noticias_id'
                                GROUP BY 
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    <form action="noticias.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="noticias_id" value="<?php echo $row['noticias_id'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="data_publicacao" value="<?php echo $row['data_publicacao'] ?>"
                                                class="form-control" placeholder="Editar data de publicação">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($row['img_noticia'])): ?>
                                                <img src="../../inserir/imgs/noticias/<?php echo $row['img_noticia']; ?>"
