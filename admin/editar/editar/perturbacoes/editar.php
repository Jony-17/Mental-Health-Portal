                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Perturbações
                            </h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                $perturbacoes_id = $_POST['edit_id'];

                                $query = "SELECT * FROM perturbacoes WHERE perturbacoes_id = $perturbacoes_id";
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    <form action="perturbacoes.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="perturbacoes_id" value="<?php echo $row['perturbacoes_id'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($row['img_perturbacao'])): ?>
                                                <img src="../../inserir/imgs/perturbacoes/<?php echo $row['img_perturbacao']; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if (!empty($row['banner_perturbacao'])): ?>
                                                <img src="../../inserir/imgs/perturbacoes/banners/<?php echo $row['banner_perturbacao']; ?>"
                                                    alt="Banner atual" style="max-width: 200px; max-height: 200px;">
                                            <?php else: ?>
                                                <span>Nenhuma imagem disponível.</span>
                                            <?php endif; ?>
                                        </div>
