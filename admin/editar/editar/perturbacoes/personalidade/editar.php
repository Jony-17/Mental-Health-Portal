                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Perturbações de personalidade
                            </h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                $perturbacoes_personalidade_id = $_POST['edit_id'];

                                $query = "SELECT * FROM perturbacoes_personalidade WHERE perturbacoes_personalidade_id = $perturbacoes_personalidade_id";
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    ?>
                                    <form action="perturbacoes-personalidade.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="perturbacoes_personalidade_id" value="<?php echo $row['perturbacoes_personalidade_id'] ?>">
                                        ...
                                        <div class="form-group">
                                            <label>Texto de sintomas</label>
                                            <input type="text" name="sintomas_texto" value="<?php echo $row['sintomas_texto'] ?>"
                                                class="form-control" placeholder="Editar texto dos sintomas">
                                        </div>

                                        <div class="form-group">
                                            <label>Texto de prevalências</label>
                                            <input type="text" name="prevalencias_texto" value="<?php echo $row['prevalencias_texto'] ?>"
                                                class="form-control" placeholder="Editar texto das prevalências">
                                        </div>

                                        <div class="form-group">
                                            <label>Texto de ajuda</label>
                                            <input type="text" name="ajuda_texto" value="<?php echo $row['ajuda_texto'] ?>"
