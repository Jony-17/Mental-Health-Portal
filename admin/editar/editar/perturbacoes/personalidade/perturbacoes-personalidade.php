...
if (isset($_POST['inserirbtn'])) {
    ...
    $query = "UPDATE perturbacoes_personalidade SET nome = '$nome', texto = '$texto', sintomas_texto = '$sintomas_texto', prevalencias_texto = '$prevalencias_texto', ajuda_texto = '$ajuda_texto' WHERE perturbacoes_personalidade_id = $perturbacoes_personalidade_id";
