                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Junção de perturbações
                            </h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                $juncao_perturbacoes_id = $_POST['edit_id'];

                                $query = "SELECT
                                            j.juncao_perturbacoes_id,
                                            j.perturbacoes_id,
                                            p.nome AS nome_perturbacao,
                                            j.grupos_perturbacoes_id,
                                            g.nome AS nome_grupo
                                          FROM
                                            juncao_perturbacoes j
                                          INNER JOIN
                                            perturbacoes p ON j.perturbacoes_id = p.perturbacoes_id
                                          INNER JOIN
                                            grupos_perturbacoes g ON j.grupos_perturbacoes_id = g.grupos_perturbacoes_id
                                          WHERE
                                            j.juncao_perturbacoes_id = '$juncao_perturbacoes_id'";
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    ?>
                                    <form action="juncao-perturbacoes.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="juncao_perturbacoes_id"
                                            value="<?php echo $row['juncao_perturbacoes_id'] ?>">
