                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Quizzes
                            </h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                ...
                                WHERE quiz_nome.quiz_nome_id = $quiz_nome_id";
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    <form action="quizzes.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="quiz_nome_id" value="<?php echo $row['quiz_nome_id'] ?>">

                                        <div class="form-group">
                                            <label>Nome</label>
                                            <input type="text" name="nome" value="<?php echo $row['nome'] ?>"
                                                class="form-control" placeholder="Editar nome">
                                        </div>

                                        <div class="form-group">
                                            <label>Imagem atual</label><br>
                                            <?php if (!empty($row['img_quiz'])): ?>
                                                <img src="../../inserir/imgs/quizzes/<?php echo $row['img_quiz']; ?>" alt="Imagem atual"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="explicacao_quiz" value="<?php echo $row['explicacao_quiz'] ?>"
                                                class="form-control" placeholder="Editar explicação do quiz">
                                        </div>

                                        <div class="form-group">
                                            <label>Texto</label>
                                            <input type="text" name="texto_informacao" value="<?php echo $row['texto_informacao'] ?>"
                                                class="form-control" placeholder="Editar texto de informação">
                                        </div>

                                        <div class="form-group">
                                            <label>Pergunta</label>
                                            <input type="text" name="questao" value="<?php echo $row['questao'] ?>"
                                                class="form-control" placeholder="Editar questao">
                                        </div>

                                        <div class="form-group">
                                            <label>Opção A</label>
                                            <input type="text" name="opcao_a" value="<?php echo $row['opcao_a'] ?>"
                                                class="form-control" placeholder="Editar opção a">
                                        </div>

                                        <div class="form-group">
                                            <label>Opção B</label>
                                            <input type="text" name="opcao_b" value="<?php echo $row['opcao_b'] ?>"
                                                class="form-control" placeholder="Editar opção b">
                                        </div>

                                        <div class="form-group">
                                            <label>Resposta</label>
                                            <input type="text" name="resposta" value="<?php echo $row['respostas'] ?>"
                                                class="form-control" placeholder="Editar resposta">
                                        </div>

                                        <div class="form-group">
                                            <label>Quantidade(intervalo)</label>
                                            <input type="text" name="qtd" value="<?php echo $row['qtd'] ?>"
                                                class="form-control" placeholder="Editar quantidade">
                                        </div>
