                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                $ted_talks_id = $_POST['edit_id'];

                                $query = "SELECT * FROM ted_talks WHERE ted_talks_id='$ted_talks_id' ";
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    ...
                                    <form action="ted-talks.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="ted_talks_id" value="<?php echo $row['ted_talks_id'] ?>">
                                        ...
                                        <div class="form-group">
                                            <label>Data</label>
                                            <input type="text" name="data" value="<?php echo $row['data'] ?>"
                                                class="form-control" placeholder="Editar data">
                                        </div>

                                        <div class="form-group">
                                            <label>Tempo</label>
                                            <input type="text" name="tempo" value="<?php echo $row['tempo'] ?>"
                                                class="form-control" placeholder="Editar tempo">
                                        </div>

                                        <div class="form-group">
                                            <label>Imagem atual</label><br>
                                            <?php if (!empty($row['img_ted_talks'])): ?>
                                                <img src="../../inserir/imgs/ted-talks/<?php echo $row['img_ted_talks']; ?>" alt="Imagem atual"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link" value="<?php echo $row['link'] ?>"
                                                class="form-control" placeholder="Editar link">
                                        </div>
