                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Inserir 10 factos de cada perturbação
                                </h5>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">10 factos de cada perturbação</h6>
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            while ($row = mysqli_fetch_assoc($query_run)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="10-factos.php" method="post">
                                                            <input type="hidden" name="delete_id"
                                                                value="<?php echo $row['10_factos_id']; ?>">
