...
if (isset($_POST['delete_btn'])) {
    $exercicios_mindfulness_id = $_POST['delete_id'];

    // Consulta para excluir o conteúdo da notícia
    $delete1 = "DELETE FROM exercicios_mindfulness_ex WHERE exercicios_mindfulness_id = '$exercicios_mindfulness_id'";
    $delete1_result = mysqli_query($conn, $delete1);

    // Consulta para excluir a notícia
    $delete2 = "DELETE FROM exercicios_mindfulness WHERE exercicios_mindfulness_id = '$exercicios_mindfulness_id'";
