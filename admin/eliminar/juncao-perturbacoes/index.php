                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Inserir junção de perturbações</h5>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Junção de perturbações</h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <?php
                                $query = "SELECT juncao_perturbacoes_id, j.juncao_perturbacoes_id, p.nome AS nome_perturbacao, g.grupos_perturbacoes_id, g.nome AS nome_grupo, p.perturbacoes_id
                                FROM juncao_perturbacoes j
                                INNER JOIN perturbacoes p ON j.perturbacoes_id = p.perturbacoes_id
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            while ($row = mysqli_fetch_assoc($query_run)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="juncao-perturbacoes.php" method="post">
                                                            <input type="hidden" name="perturbacoes_id"
                                                                value="<?php echo $row['perturbacoes_id']; ?>">

                                                            <input type="hidden" name="grupos_perturbacoes_id"
                                                                value="<?php echo $row['grupos_perturbacoes_id']; ?>">
