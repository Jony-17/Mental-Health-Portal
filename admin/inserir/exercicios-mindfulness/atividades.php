                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['edit_btn'])) {
                                ...
                                $query = "SELECT * FROM exercicios_mindfulness WHERE exercicios_mindfulness_id='$exercicios_mindfulness_id' ";
                                $query_run = mysqli_query($conn, $query);

                                if (mysqli_num_rows($query_run) > 0) { // Check if exercise is found
                                    ...
                                    <form action="exercicios-mindfulness-inserir.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="edit_nome" value="<?php echo $row['nome'] ?>"
                                                class="form-control" placeholder="Inserir Nome" readonly>
                                        </div>
                                        <div class="form-group">
