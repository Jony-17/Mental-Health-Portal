                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Inserir grupo de perturbações</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="grupos-perturbacoes.php" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="prevalencias" class="form-control">
                                    </div>
                                    <div class="form-group">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Grupo de perturbações</h6>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <?php
                                $query = "SELECT * FROM grupos_perturbacoes";
