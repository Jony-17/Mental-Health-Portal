...
<body>
    ...
    <div class="owl-carousel owl-theme">
        <div class="item">
            <p>Gato-Vaca (Marjaryasana-Bitilasana)</p>
            <img src="https://cdn.yogajournal.com/wp-content/uploads/2022/06/Childs-Pose_Andrew-Clark.jpg?width=730" alt="">
        </div>
        <div class="item">
            <p>Posição de criança (Balasana)</p>
            <img src="https://cdn.yogajournal.com/wp-content/uploads/2021/11/Downward-Facing-Dog-Pose-Mod-1_Andrew-Clark_1.jpg?width=730" alt="">
        </div>
        <div class="item">
            <p>Posição de montanha (Tadasana)</p>
            <img src="https://cdn.yogajournal.com/wp-content/uploads/2021/11/Chair-Pose_Andrew-Clark.jpg?width=730" alt="">
        </div>
    </div>
    ...
    <div class="fontes" id="fontes">
        ...
        <div class="fontes-content2">
            <p>1. https://www.yogajournal.com/practice/</p>
        </div>
    </div>
