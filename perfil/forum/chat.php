...
<head>
  ...
  <title>Fórum | Portal de Saúde Mental</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Aqui podes partilhar todos os teus conhecimentos e experiências com todos
              os alunos.</h1>
          </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Fórum
                </h6>
              </div>
                ...
                <div class="table-responsive">
                  ...
                  <div class="wrapper">
                    <section class="chat-area">
                      <header>
                        <?php
                        $user_id = mysqli_real_escape_string($conn, $_GET['utilizador_id']);
                        $sql = mysqli_query($conn, "SELECT * FROM utilizadores WHERE unique_id = {$user_id}");
                      ...
                      <form action="#" class="typing-area">
                        <input type="text" class="incoming_id" name="incoming_id" value="<?php echo $user_id; ?>"
                          hidden>
                        <input type="text" name="message" class="input-field" placeholder="Escreva aqui a mensagem..."
                          autocomplete="off">
