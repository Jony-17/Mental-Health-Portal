...
(1, 1, 1, 'Symptoms', 'São as condições de saúde mental mais comuns e por isso são as que têm maior prevalência.', 'American Psychiatric Association. (2013). Diagnostic and statistical manual of mental disorders (5th ed.). American Psychiatric Publishing. https://doi.org/10.1176/appi.books.9780890425596'),
(2, 1, 2, 'Introdução', 'Começam na infância ou adolescência, com a idade média de início de 11 anos.  ', ''),
(3, 1, 3, 'Testeteste', 'É extremamente comum que as perturbações de ansiedade coexistam com outras condições de saúde mental.', ''),
(4, 1, 4, 'Teste4', 'Podem causar problemas significativos no sono, incluindo insónias.', ''),
(5, 1, 5, 'Teste5', 'Há uma forte componente genética.', ''),
(6, 1, 6, 'Teste6', 'As mulheres são duas vezes mais propensas do que os homens a desenvolver perturbações de ansiedade.', ''),
(7, 1, 7, 'Teste7', 'Pessoas com perturbações de ansiedade têm, frequentemente, alterações em regiões do cérebro que regulam emoções.', ''),
(8, 1, 8, 'Teste8', 'Terapias cognitivo-comportamentais (TCC) e medicamentos, são tratamentos eficazes para muitas perturbações de ansiedade.', ''),
(9, 1, 9, 'Teste9', 'Podem causar uma série de sintomas físicos, incluindo dor de cabeça, tensão muscular, problemas digestivos e palpitações cardíacas.', ''),
(10, 1, 10, 'Teste10', 'Apesar da sua prevalência, ainda existe um estigma significativo em torno das perturbações de ansiedade, o que pode levar a atrasos no diagnóstico e no tratamento.', ''),
(14, 3, 1, 's', 'São extremamente comuns e afetam milhares de pessoas em todo o mundo.', 'American Psychiatric Association. (2013). Diagnostic and statistical manual of mental disorders (5th ed.). American Psychiatric Publishing. https://doi.org/10.1176/appi.books.9780890425596'),
(15, 3, 2, 'a', 'As mulheres têm uma probabilidade significativamente maior de serem diagnosticadas com perturbações depressivas, enquanto os homens têm uma probabilidade ligeiramente maior de serem diagnosticados com perturbação bipolar.', ''),
(16, 3, 3, 'a', 'Podem começar em qualquer idade, sendo mais como na adolescência e início da idade adulta.', ''),
(17, 3, 4, 'a', 'É extremamente comum que as perturbações de humor coocorram com perturbações de ansiedade.', ''),
(18, 3, 5, 'a', 'A depressão é uma das maiores causas de incapacidade do mundo.', ''),
(19, 3, 6, 'a', 'Pessoas com parentes de primeiro grau com perturbações bipolares ou depressivas têm um risco significativo de desenvolver os mesmos.', ''),
(20, 3, 7, 'a', 'Ambas as perturbações podem ocorrer com perturbações de sono, como insónias.', ''),
(21, 3, 8, 'a', 'Embora as perturbações de humor possam ser graves, existem muitos tratamentos eficazes disponíveis, incluindo psicoterapia e medicamentos.', ''),
(22, 3, 9, 'w', 'A conscientização e a educação pública são fundamentais para reduzir o estigma e encorajar o tratamento deste tipo de perturbações', ''),
(23, 3, 10, 'q', 'Além dos fatores genéticos e fatores ambientais, traumas na infância e eventos de vida adversos também desempenham um papel importante no desenvolvimento e curso destas perturbações.', ''),
(24, 2, 1, 'a', 'A insônia crónica pode aumentar o risco de desenvolver outras condições de saúde.', 'American Psychiatric Association. (2013). Diagnostic and statistical manual of mental disorders (5th ed.). American Psychiatric Publishing. https://doi.org/10.1176/appi.books.9780890425596'),
(25, 2, 2, 'a', 'Cerca de 80% dos casos de apneia do sono não são diagnosticados, podendo causar interrupções frequentes no sono.', ''),
(26, 2, 3, 'a', 'Trabalhadores com turnos noturnos têm maior probabilidade de desenvolver perturbações do ritmo circadiano.', ''),
(27, 2, 4, 'a', 'Parassónias (sonambulismo ou terrores noturnos) podem ser perigosos, pois a pessoa não está consciente das suas ações.', ''),
(28, 2, 5, 'a', 'A falta de sono adequado pode prejudicar a consolidação da memória, afetando negativamente a capacidade de aprender e reter novas informações.', ''),
(29, 2, 6, 'a', 'A exposição à luz azul de dispositivos eletrónicos antes de dormir pode interferir na produção de melatonina, a hormona que regula o sono, dificultando o adormecer.', ''),
