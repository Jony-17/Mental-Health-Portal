...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20-Jun-2024 às 14:58
...
(7, 'Perturbações relacionadas com Trauma e Fatores de stress', 'As perturbações de stress são um conjunto de condições psicológicas definidas pelo DSM-5 (Manual Diagnóstico e Estatístico de Perturbações Mentais, 5ª edição) que são desencadeadas por experiências stressantes ou traumáticas. Estas condições incluem a exposição a um evento traumático que envolveu ameaça à vida ou integridade física própria ou de outras pessoas. Os sintomas incluem flashbacks, pesadelos, evitação de estímulos relacionados ao trauma e hiperatividade do sistema nervoso. Estas perturbações de stress podem ter um impacto significativo na qualidade de vida e funcionamento diário das pessoas afetadas, podendo exigir intervenção terapêutica e apoio adequados para recuperação (APA, 2013). ', 'pert-stress.png', NULL, 'banner-stress.png', 'American Psychiatric Association. (2013). Diagnostic and statistical manual of mental disorders (5th ed.). American Psychiatric Publishing. https://doi.org/10.1176/appi.books.9780890425596');
...
--
ALTER TABLE `lembrete`
  MODIFY `lembrete_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `quizzes`
  MODIFY `quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
