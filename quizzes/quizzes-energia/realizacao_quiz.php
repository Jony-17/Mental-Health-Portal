...
if (isset($_SESSION['id_utilizador'])) {
    ...
    $quiz_energia_id = 1; // Define como NULL, já que não queremos inserir um ID de quiz de preocupação
    ...
    $query = "INSERT INTO quizzes (utilizador_id, quiz_empatia_id, quiz_preocupacao_id, quiz_energia_id, quiz_emocao_id) VALUES ('$utilizador_id', NULL, NULL, '$quiz_energia_id', NULL)";
