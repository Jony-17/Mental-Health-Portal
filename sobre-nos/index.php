...
<body>
    ...
    <section class="sobre-nos" id="sobre-nos">
        <div class="sobre-nos-texto">
            <h2>“Diz-se que a inteligência não pode ser ensinada, mas pode ser despertada, inspirada, desenvolvida,
                por um ensino correto e em condições propícias.”</h2>
            <p>— Prof. Coordenador Principal Lino Augusto Tavares Dias</p>
        </div>
